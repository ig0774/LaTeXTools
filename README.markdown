...
- the final product is a PDF which will be written to the output directory or the same directory as the main file and named `$jobname.pdf`
- the LaTeX log will be written to the output directory, the auxiliary directory or the same directory as the main file and named `$jobname.log`
